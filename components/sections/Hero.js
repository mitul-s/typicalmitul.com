...
const Hero = () => {
  return (
    <div className="grid h-full rounded-lg shadow bg-yolk ring-2 ring-offset-4 ring-yolk shadow-yolk">
      ...
      <h2 className="hero-heading flex justify-center items-center overlay z-10 text-[72px] font-[900] leading-none tracking-tighter -mt-4">
        CHASING LIFE
      </h2>
    </div>
  );
